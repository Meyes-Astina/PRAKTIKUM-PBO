...
public class Main {
        ...
        do {
            ...
            try {
                ...
                switch (pilihan) {
                    ...
                    case 9:
                        clearScreen();
                        PencatatPenjualan.cetakTotalPenjualan(albumList);
    ...
    static void lihatAlbumFisik() {
        ...
        if (albumList.isEmpty()) {
            ...
            System.out.println("+---------------------------------------------------------------------------------+");
            System.out.println("| No | Judul                | Artist               | Genre         | Berat (kg) |");
            System.out.println("+---------------------------------------------------------------------------------+");
            int no = 1;
            for (Album album : albumList) {
                if (album instanceof AlbumFisik) {
                    AlbumFisik albumFisik = (AlbumFisik) album;
                    double beratKg = albumFisik.getBerat() / 1000.0; // Konversi gram ke kilogram
                    System.out.printf("| %-2d | %-20s | %-20s | %-13s | %-11.2f |\n",
                            no++, albumFisik.getJudul(), albumFisik.getArtist(),
                            albumFisik.getGenre(), beratKg);
                }
            }
            System.out.println("-----------------------------------------------------------------------------");
        }
